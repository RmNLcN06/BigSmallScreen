...
$articleAmount = 'SELECT count(*) AS user_amount FROM `users`';
...
$nbrArticle = (int) $result['user_amount'];
...
$articleAmount = "SELECT * FROM users ORDER BY users.created_at DESC LIMIT :firstarticle, :articlesperpage";
