<!-- <div class="menu__content">
    <ul class="menu__content--list">
        ...
        <li><a href="admin_dashboard_user.php">Tableau de bord Utilisateurs</a></li>
        <li><a href="admin_dashboard_admin.php">Tableau de bord Administrateurs</a></li>
        <li><a href="admin_dashboard_article.php">Tableau de bord Articles</a></li>
        <li><a href="admin_dashboard_comment.php">Tableau de bord Commentaires</a></li>
    </ul>
</div> -->
