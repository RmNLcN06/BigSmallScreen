...
$articleAmount = 'SELECT count(*) AS article_amount FROM `articles` WHERE category_id = 3';
...
$articleAmount = "SELECT * FROM categories INNER JOIN articles ON articles.category_id = categories.id WHERE articles.category_id = 3 ORDER BY articles.created_at DESC LIMIT :firstarticle, :articlesperpage";
...
<head>
    ...
    <title>Liste des articles - Actualités</title>
...
<body>
    <?php include('../../inc/_admin_filter_header.php'); ?>
    <div class="container">
    ...
    <main class="container">
        <div class="row">
            <section class="col-12">
                ...
                ?>
                <h1 class="d-flex justify-content-center my-5">Liste des articles - Actualités</h1>
                <div class="d-flex align-items-center justify-content-center my-5">
                    <a href="../add_infos.php" class="btn btn-primary d-flex justify-content-center">Ajouter un article</a>
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav row col-12">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <li class="nav-item d-flex justify-content-center mx-2 px-4">
                                    <a class="nav-link text-white btn btn-primary" href="../filter/actualities_filter.php">Actualités</a>
                                </li>
                                <li class="nav-item d-flex justify-content-center mx-2 px-4">
